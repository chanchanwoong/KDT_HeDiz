...
function ReviewList () {
    ...
    const itemTemplate = (product, index) => {
        return (
            <div className="col-12" key={product.review_seq}>
                <div className={classNames('flex flex-column xl:flex-row xl:align-items-start p-4 gap-4', { 'border-top-1 surface-border': index !== 0 })}>
                    <img className="w-9 sm:w-16rem xl:w-10rem shadow-2 block xl:block mx-auto border-round" src={product.review_photo} alt={product.review_photo} />
